...
python2.7 ../supermassa/src/SuperMASSA.py --print_genotypes --inference f1 --ploidy_range 6:12 --naive_posterior_reporting_threshold 0.8 --file SugSNP_382.pro --f1_parent_data SugSNP_382.par
...
# In the example, we use -n 0.80 to only keep individuals with 
